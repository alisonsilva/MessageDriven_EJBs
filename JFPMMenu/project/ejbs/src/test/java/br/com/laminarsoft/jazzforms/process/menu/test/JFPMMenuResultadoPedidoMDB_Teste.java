...
public class JFPMMenuResultadoPedidoMDB_Teste {
    private static final Logger log = Logger.getLogger(JFPMMenuResultadoPedidoMDB_Teste.class.getName());

    // Set up all the default values
    private static final String DEFAULT_MESSAGE = "Mensagem de erro default";
    private static final String DEFAULT_CONNECTION_FACTORY = "jms/RemoteConnectionFactory";
    private static final String DEFAULT_DESTINATION = "jms/queue/limpaTrilhoPedidoProcQ";
